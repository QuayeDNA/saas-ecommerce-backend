...
commissionRecordSchema.methods.markAsPaid = function(paidBy, paymentReference = null) {
  this.status = 'paid';
...
commissionRecordSchema.statics.calculateCommission = async function(agentId, tenantId, startDate, endDate) {
