...
router.get('/agent',
  ...
  async (req, res) => {
    try {
      ...
      const analytics = await analyticsService.getAgentAnalytics(userId, tenantId, timeframe);
  ...
  async (req, res) => {
    try {
      ...
      if (userType === 'super_admin') {
        ...
        analytics = await analyticsService.getAgentAnalytics(userId, tenantId, timeframe);
      }
  ...
  async (req, res) => {
    try {
      ...
      if (userType === 'super_admin') {
        ...
        chartData = await analyticsService.getAgentChartData(userId, tenantId, timeframe);
      }
